...
public class FloatingViewService extends Service {
    ...
    public void onCreate() {
        ...
        */
        ...
        SpeedometerView speedometer = mFloatingView.findViewById(R.id.speedometer);
        // Add label converter
        ...
        speedometer.setMajorTickStep(15);
        speedometer.setMinorTicks(3);

        // Configure value range colors
        speedometer.addColoredRange(0, 45, Color.GREEN);
        speedometer.addColoredRange(45, 60, Color.YELLOW);
        speedometer.addColoredRange(60, 400, Color.RED);
